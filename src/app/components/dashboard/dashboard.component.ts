...
import { faCalendarAlt, faClock, faEdit, faTrashAlt }from '@fortawesome/free-regular-svg-icons';
...
export class DashboardComponent implements OnInit {
  ...
  loadAllEvents(): void {
    ...
    this.eventList.sort((a, b) => a.startDate - b.startDate || a.endDate - b.endDate);
    this.loading = false;
  }
}
